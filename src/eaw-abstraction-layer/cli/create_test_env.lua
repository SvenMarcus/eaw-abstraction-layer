...
io.write(
    "Please enter a path to the location where you would like to create the test project including the test project's name (the project folder will be created if it does not exist)\n"
)
...
if string.len(mod_path) > 0 then
    mod_path = surround_with_quotes(mod_path)
end
