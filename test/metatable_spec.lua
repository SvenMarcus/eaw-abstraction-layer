...
local optional = metatables.optional
...
-- test["When calling method with missing optional arg -> should not raise error"] = function()
--     local sut = callback_method("sut")
--     sut.expected = arguments {
--         optional "boolean"
--     }
...
-- test["When calling method with optional arg -> should not raise error"] = function()
--     local sut = callback_method("sut")
--     sut.expected = arguments {
--         optional "boolean"
--     }
